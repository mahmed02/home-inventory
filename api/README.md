...
| `PINECONE_API_KEY` | unset | required | required | yes |
| `PINECONE_INDEX_NAME` | unset | required | required | yes |
...
- Reindex item embeddings/documents into Pinecone: `npm --prefix ./api run embeddings:reindex`
